...
class ContentVGGRegularizer(ActivityRegularizer):
    ...
    def __call__(self, x):
        batch_size = K.shape(x.output)[0] // 2

        generated = x.output[:batch_size] # Generated by network features
        content = x.output[batch_size:] # True X input features
